...
ORCH_ENV_VARS="${ORCH_ENV_VARS},MARKET_MCP_URL=${MCP_URL[${MARKET_MCP_SERVICE}]}/mcp"
ORCH_ENV_VARS="${ORCH_ENV_VARS},PORTFOLIO_MCP_URL=${MCP_URL[${PORTFOLIO_MCP_SERVICE}]}/mcp"
ORCH_ENV_VARS="${ORCH_ENV_VARS},NEWS_MCP_URL=${MCP_URL[${NEWS_MCP_SERVICE}]}/mcp"
